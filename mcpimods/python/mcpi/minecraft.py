...
class CmdPositioner:
    ...
    def getRotationYaw(self, id):
        """Get entity rotation yaw (entityId:int) => float"""
        return float(self.conn.sendReceive(self.pkg + ".getRotationYaw", id))
...
class CmdPlayer(CmdPositioner):
    ...
    def getRotationYaw(self, *args):
        return CmdPositioner.getRotationYaw(self, self.name)
